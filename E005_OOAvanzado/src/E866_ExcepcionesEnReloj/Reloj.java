...
public class Reloj extends Object {
    private int h, m;
    ...
    public void tick() throws DesbordamientoRelojExcepcion, OperacionNegativaRelojExcepcion {
        sumarMinutos(1);
    }

    public void sumarMinutos(int minutos) throws DesbordamientoRelojExcepcion, OperacionNegativaRelojExcepcion {
//        m = m + minutos;
//
//        normalizar();

        if (minutos < 0) throw new OperacionNegativaRelojExcepcion("No me pongas negativos. Inténtalo de nuevo.");
        if (60*h+m + minutos >= 24*60) throw new DesbordamientoRelojExcepcion("Te has intentado salir del rango.", true);
...
//        normalizar();
        ...
        if (minutos < 0) throw new OperacionNegativaRelojExcepcion("No me pongas negativos. Inténtalo de nuevo.");
        if (60*h+m - minutos < 0) throw new DesbordamientoRelojExcepcion("Te has intentado salir del rango.", false);
