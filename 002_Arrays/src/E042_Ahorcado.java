...
public class E042_Ahorcado {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);

        System.out.printf("........Turno del jugador 1.......... \n");

        System.out.printf("Introduzca la cantidad de letras que quieras adivinar: ");
        ...
        do {
            ...
            intentos = intentos + cantidadChars-1;
        ...
        if (Arrays.equals(letras,letrasSecretas)){
